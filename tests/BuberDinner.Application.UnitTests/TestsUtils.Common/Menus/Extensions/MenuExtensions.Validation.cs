...
namespace BuberDinner.Application.UnitTests.TestsUtils.Common.Menus.Extensions
{
    public static partial class MenuExtensions
    {
        public static void ValidateCreatedFrom(this Menu menu, CreateMenuCommand command)
        {
            ...
            menu.HostId.Should().Be(HostId.Create(Guid.Parse(command.HostId)));
            menu.Sections
                .Zip(command.Sections)
                .ToList()
